...
//     // const apiRes =  await axios.get('http://localhost:2001/api/songs')
//     // console.log(apiRes)

//     useEffect(() => {
//         const fetchSongs = async () => {
//             try {
//                 const response = await axios.get('http://localhost:2001/api/songs');
...
//                     <div key={song._id} className='card shadow-md my-1'>
...
//     const fetchSongs = async () => {
//         try {
//             const response = await axios.get('http://localhost:2001/api/songs', { cache: 'no-store' });
//             setListOfSongs(response.data);
//         } catch (error) {
//             console.error('Error fetching songs:', error);
//         }
...
//     return (
//         <Songs listOfSongs={listOfSongs} handleRefresh={handleRefresh} />
//     );
// }
...
const fetchSongs = async () => {
    try {
        const response = await axios.get('http://localhost:2001/api/songs', { cache: 'no-store', revalidate: 20 });
...
const Songs = async () => {
    const listOfSongs = await fetchSongs();
